    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <p className="mb-5 text-sm leading-relaxed text-white/55">
          Все ваши вакансии и история переписок будут анонимизированы. Откатить нельзя.
          <br />
          <br />
          Для удаления компании свяжитесь с поддержкой:{' '}
          <a
    ...
    <>
      ...
      <div className="space-y-3.5">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-white/45">Аккаунт, команда и безопасность</p>
        </div>

        {/* ── 1. Credentials ── */}
        <section className="rounded-[14px] border border-white/[0.06] bg-white/[0.04] p-5">
          <h2 className="mb-4 text-[15px] font-semibold text-white/90">Учётные данные</h2>
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            ...
            <span className="block text-[13px] text-white/45">
              Уведомления об откликах, приглашениях и сообщениях на почту
            </span>
          </span>
