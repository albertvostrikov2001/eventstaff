  ...
  return (
    ...
    <div className="container-page py-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white">Вакансии</h1>
          <p className="mt-1 text-sm text-white/55">Найдите работу в event-индустрии</p>
        </div>
        <button
      ...
      {showFilters && (
        <div className="mt-4 rounded-card border border-white/[0.08] bg-white/[0.04] p-4">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <div>
              <label className="block text-xs font-medium text-white/60 mb-1">Тип мероприятия</label>
              <select
            ...
            <div>
              <label className="block text-xs font-medium text-white/60 mb-1">Тип занятости</label>
              <select
      ...
      <div className="mt-4 flex items-center justify-between">
        <span className="text-sm text-white/55">{total} вакансий</span>
        <select
