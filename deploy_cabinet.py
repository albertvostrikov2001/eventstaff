"""
Cabinet features deploy (chat access, nav notification badges, onboarding hints).
Syncs api/src + shared/src + web/src + web/public, rebuilds API + Web, restarts PM2.
No schema changes — no migration / prisma generate needed.

Run: python deploy_cabinet.py
Credentials via .env.deploy.
"""
import paramiko
import tarfile
import io
...
REMOTE_TMP = '/tmp/unity_deploy_cabinet.tar.gz'
